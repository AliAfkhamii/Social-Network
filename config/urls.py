...
schema_view = get_schema_view(
    openapi.Info(
        title="social network blog API",
        default_version='v1',
        description="a blog that works like a social network",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="contact@ali.local"),
...
urlpatterns += swagger + staticfiles + media
